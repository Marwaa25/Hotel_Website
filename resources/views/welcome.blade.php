...
<div class="container">
    <div class="newsletter_main">
        <h1><br> {{__('Localisation d\'hôtel Cote d\'or à M\'diq, Maroc')}}</h1>
        <div class="google"><a href="https://www.google.com/maps/place/M'diq, Maroc/">{{__('Voir sur Google Maps')}}</a></div>
    </div>
    ...
    <p>Av Casablanca lot n°90 M'diq, {{__('Maroc se trouve dans la ville de M\'diq, Maroc')}}.</p>
</div>
@endsection
