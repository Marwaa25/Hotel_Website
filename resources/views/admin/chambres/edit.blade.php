...
<form action="{{ route('admin.chambres.update', $chambre->id) }}" method="POST">
    ...
    <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-300 ease-in-out">Enregistrer</button>
</form>
@endsection